...
async function createAnimal(req, res, next) {
    try {
        ...
        if (!data.nome || !data.tipo  || !data.proprietario_id ) {
            throw new ErrorHandler(400, 'Missing required nome, tipo, or proprieratio_id fields');
        }
...
async function deleteAnimal(req, res, next) {
    try {
        ...
        // TODO TESTAR SE TEM ALGUM ANIMAL VINCULADO SE TIVER NÃO PODE REMOVER
...
export default {createAnimal, updateAnimal,  deleteAnimal, listarAnimalPorID,  listarAnimais };
